...
\resumeItemListStart
\resumeItem{Full Stack Developer}{Worked on Creating the Backend services and the frontend Flutter cross platform application.}

\resumeItem{Microservices}{Design Microservices for the health cloud application. Services for handling communications, sending email and text messages to users.}

\resumeItem{Flutter App Architecture}{Develop the architecture of Be.Well cross platform mobile app}

\resumeItem{Graphql APIs}{Serve RESTful APIs through graphql API server}
...
\resumeItemListStart
\resumeItem{Tests}{Increase code coverage from 20 to 95\%. Test the business logic.}

\resumeItem{Code Deployment}{Make it easy to deploy code to production through use of docker.}

\resumeItem{Gitlab CI/CD}{Make the application stable by continuous running tests.}
...
\item[Frameworks: ] Android, GraphQL, Django, React
